...
void solveRK4(Punkt *p, float dt){
	...
	k3[0] = (p->f*(1/p->m) + k2[1]/2)*dt;
	k3[1] = (p->v + k2[0]/2) * dt;

	k4[0] = (p->f*(1/p->m) + k3[1])*dt;
	k4[1] = (p->v + k3[0]) * dt;


	
	p->v = p->v + (k1[0] + 2*k2[0] + 2*k3[0] + k4[0])/6;
	p->r = p->r + (k1[1] + 2*k2[1] + 2*k3[1] + k4[1])/6;
